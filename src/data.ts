...
const img = {
  ...
  chickenPlate: '/images/22cac9_e928c8911f98408da5f60bcc91b5646f.jpg',
  meatSkewerPlate: '/images/22cac9_d04fc70ee2ab4bea85bc57d3b4e0a9b1.jpg',
  ...
  fruitSalad: '/images/fruit-salad.jpg',
  iceCream: '/images/ice-cream.jpg',
  yogurt: '/images/yogurt.jpg',
  cheese: '/images/cheese.jpg',
  soda: '/images/soda.jpg',
  sodaLarge: '/images/bottle-15l.jpg',
  oasis: '/images/oasis.jpg',
  magnum: '/images/magnum.jpg',
  water: '/images/water.jpg',
  ayran: '/images/ayran-real.jpg',
  greekSalad: '/images/greek-feta.jpg',
  chickenSalad: '/images/chicken-salad.jpg',
} as const
...
export const gallery: { key: GalleryKey; src: string }[] = [
  ...
  { key: 'mixte', src: img.chickenPlate },
...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'merguez', price: '5,00 €', image: img.merguez },
      {
        id: 'kebabPainEntier',
        price: '8,50 €',
        image: img.grillSandwich,
      ...
      { id: 'fromage', price: '0,50 €', image: img.cheese },
    ],
  },
  {
    id: 'assiettes',
    ...
    items: [
      ...
      {
        id: 'assietteBrochettePoulet',
        price: '9,00 €',
        image: img.chickenPlate,
      },
      {
        id: 'assietteBrochetteAgneau',
        price: '10,00 €',
        image: img.meatSkewerPlate,
      },
      {
        id: 'assietteChickenChika',
        price: '8,00 €',
        image: img.chickenPlate,
      },
    ],
  },
  {
    id: 'entrees',
    items: [
      { id: 'saladeBergere', price: '5,50 €', image: img.shepherd },
      { id: 'saladeFermiere', price: '5,50 €', image: img.chickenSalad },
      { id: 'saladeGrecque', price: '5,50 €', image: img.greekSalad },
      { id: 'feuillesVigne', price: '4,50 €', image: img.dolma },
      { id: 'tzatziki', price: '4,50 €', image: img.tzatziki },
    ],
  },
  {
    id: 'desserts',
    items: [
      ...
      { id: 'cremeBrulee', price: '4,00 €', image: img.cremeBrulee },
      { id: 'ileFlottante', price: '4,00 €', image: img.ileFlottante },
      { id: 'saladeFruits', price: '4,00 €', image: img.fruitSalad },
      { id: 'fromageBlanc', price: '4,00 €', image: img.yogurt },
      { id: 'glace', price: '1,50 €', image: img.iceCream },
      { id: 'magnum', price: '2,00 €', image: img.magnum },
      { id: 'boisson33', price: '1,50 €', image: img.soda },
      { id: 'eau', price: '1,00 €', image: img.water },
      { id: 'boisson15', price: '3,00 €', image: img.sodaLarge },
      { id: 'oasis2l', price: '3,50 €', image: img.oasis },
